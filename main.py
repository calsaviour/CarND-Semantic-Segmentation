...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    """
    # TODO: Implement function
    # 1x1 convolutional of vgg layer 7
    ...
    # 1x1 convolutional of vgg layer 4
    layer4a_in2 = tf.layers.conv2d_transpose(vgg_layer4_out, num_classes, 1,
                  padding= 'same',
                  kernel_initializer= tf.random_normal_initializer(stddev=0.01),
                  kernel_regularizer= tf.contrib.layers.l2_regularizer(1e-3))
    ...
    # 1x1 convolutional of vgg layer 3
    layer3a_in2 = tf.layers.conv2d_transpose(vgg_layer3_out, num_classes, 1,
                  padding= 'same',
                  kernel_initializer= tf.random_normal_initializer(stddev=0.01),
                  kernel_regularizer= tf.contrib.layers.l2_regularizer(1e-3))
